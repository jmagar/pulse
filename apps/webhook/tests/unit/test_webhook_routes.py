...
def test_webhook_with_valid_signature(webhook_client: tuple[TestClient, MagicMock], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_webhook_crawl_page_event(webhook_client: tuple[TestClient, MagicMock], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_webhook_lifecycle_event(webhook_client: tuple[TestClient, MagicMock], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_webhook_accepts_job_id_v0_payload(webhook_client: tuple[TestClient, MagicMock], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_webhook_queue_failure(webhook_client: tuple[TestClient, MagicMock], monkeypatch: pytest.MonkeyPatch) -> None:
