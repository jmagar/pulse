...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_request_metrics_timestamp"), "request_metrics", ["timestamp"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_request_metrics_status_code"), "request_metrics", ["status_code"], unique=False
    )
    op.create_index(
        op.f("ix_request_metrics_duration_ms"), "request_metrics", ["duration_ms"], unique=False
    )
    op.create_index(
        op.f("ix_request_metrics_request_id"), "request_metrics", ["request_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_operation_metrics_timestamp"), "operation_metrics", ["timestamp"], unique=False
    )
    op.create_index(
        op.f("ix_operation_metrics_operation_type"),
        "operation_metrics",
        ["operation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_operation_metrics_operation_name"),
        "operation_metrics",
        ["operation_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_operation_metrics_duration_ms"), "operation_metrics", ["duration_ms"], unique=False
    )
    op.create_index(
        op.f("ix_operation_metrics_success"), "operation_metrics", ["success"], unique=False
    )
    op.create_index(
        op.f("ix_operation_metrics_request_id"), "operation_metrics", ["request_id"], unique=False
    )
    op.create_index(
        op.f("ix_operation_metrics_job_id"), "operation_metrics", ["job_id"], unique=False
    )
    op.create_index(
        op.f("ix_operation_metrics_document_url"),
        "operation_metrics",
        ["document_url"],
        unique=False,
    )
