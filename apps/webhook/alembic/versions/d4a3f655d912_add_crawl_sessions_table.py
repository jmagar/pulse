...
down_revision: str | Sequence[str] | None = "20251113_add_fk"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_webhook_crawl_sessions_started_at"),
        "crawl_sessions",
        ["started_at"],
        unique=False,
        schema="webhook",
    ...
    op.create_index(
        op.f("ix_webhook_crawl_sessions_status"),
        "crawl_sessions",
        ["status"],
        unique=False,
        schema="webhook",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_webhook_crawl_sessions_status"), table_name="crawl_sessions", schema="webhook"
    )
    op.drop_index(
        op.f("ix_webhook_crawl_sessions_started_at"), table_name="crawl_sessions", schema="webhook"
    )
