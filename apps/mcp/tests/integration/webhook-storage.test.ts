...
describeIntegration("WebhookPostgresStorage Integration", () => {
  ...
  describe("findByUrl", () => {
    it("should retrieve scraped content from webhook API", async () => {
    ...
    it("should return empty array for non-existent URL", async () => {
    ...
    it("should handle multiple results for same URL", async () => {
  ...
  describe("read", () => {
    it("should fetch content by webhook URI", async () => {
    ...
    it("should throw error for non-existent content ID", async () => {
    ...
    it("should throw error for invalid URI format", async () => {
      ...
      for (const invalidUri of invalidFormats) {
        await expect(storage.read(invalidUri)).rejects.toThrow("Invalid URI");
      }
    }, 30_000);
  });
  ...
  describe("findByUrlAndExtract", () => {
    it("should return cleaned content (extractPrompt ignored)", async () => {
      const testUrl = "https://docs.firecrawl.dev";
  ...
  describe("cache performance", () => {
    it("should demonstrate Redis caching benefit", async () => {
      const testUrl = "https://docs.firecrawl.dev";
